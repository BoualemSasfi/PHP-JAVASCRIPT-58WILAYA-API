...
if (isset($_GET['username']) && isset($_GET['key'])) {
	if ($_GET['username'] === 'alpa' && $_GET['key'] === '12345') {
		...
		echo json_encode(["message" => "ERREUR : Nom d'utilisateur ou clé incorrecte"], JSON_UNESCAPED_UNICODE);
	}
} else {
	http_response_code(400);
	echo json_encode(["message" => "ERREUR : Paramètres manquants"], JSON_UNESCAPED_UNICODE);
}
